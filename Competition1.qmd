...
```
The random forest model did not result in a better log loss metric (1.082765) than the Decision Tree model. In the original model of the random forest the "trees" parameter was tuned. In the second model, "min_n" was tuned but did not yield better results.
