...
school_edit%>%
ggplot() +
  geom_histogram(aes(x = avgSchoolRating, y = after_stat(density)), color = "black",
fill = "blue") + 
  
  labs( title = "Average School Rating Density",
    x = "School Rating",
    y = "Density"
  )
...
school_edit%>%
  ggplot() +
  geom_bar(aes(homeType), color = "black", fill = "black") + 
