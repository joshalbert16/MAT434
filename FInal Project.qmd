...
POT_HUM
```
After filtering another section of the graph where there are many overlaps, we can see that 5 of the crops have similar levels of Humidity and Potassium. This may be a slight indicator of what crops may be compatible with one another based on the climatic and at least one soil composition parameter that are specific to the crop.
